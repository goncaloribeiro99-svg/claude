...
const PERCURSO = [
  ...
  },
  {
    ...
    local: "Porto",
    destaque: true,
    cargo: { pt: "Marketing freelance, academia de padel", en: "Freelance marketing, padel academy", es: "Marketing freelance, academia de pádel" },
    desc: {
  ...
  },
  {
    ...
    desc: {
      pt: "Responsável pela criação de conteúdo nas redes sociais do maior retalhista de padel do mundo em Portugal. Conteúdo de loja, produto e comunidade. O que funciona, funciona porque é sobre o jogo e não sobre o catálogo.",
      en: "Responsible for social content for the Portuguese arm of the world's largest padel retailer. Store, product and community content. What works, works because it is about the game and not the catalogue.",
      es: "Responsable de la creación de contenido en las redes del mayor retailer de pádel del mundo en Portugal. Contenido de tienda, producto y comunidad. Lo que funciona, funciona porque va del juego y no del catálogo."
    },
...
const FERRAMENTAS = [
  ...
  "SEO / Google", "Produção de vídeo (Adobe)", "Copywriting",
  "Gestão de eventos & feiras", "Recrutamento / RH", "Go-to-market do zero"
];
...
const EMPRESAS = {
  default: {
    ...
    pitch: {
      ...
      en: {
        ...
        paras: [
          "Over three years in marketing and playing padel since 2020. These are not two separate lines in my career: my master's thesis was among the first in Portugal to cross marketing and padel.",
      ...
      es: {
        ...
        paras: [
          "Más de tres años en marketing y jugando al pádel desde 2020. No son dos cosas separadas en mi trayectoria: mi tesis de máster fue de las primeras en Portugal en cruzar marketing y pádel.",
    ...
    /* A versão genérica não apresenta metodologia. Apresenta competências.
       A mesma estrutura alimenta a secção fixada. */
    plano: {
      pt: [
  ...
  quad: {
    ...
    pitch: {
      pt: {
        ...
        paras: [
          ...
          "Uma gama que vai da FPF Edition à Dragon II do FC Porto, mais pickleball, calçado e vestuário, é território de marca de lifestyle. Isso exige alguém que saiba fazer conteúdo de produto sem parecer catálogo, que foi exatamente o que fiz na Padel Nuestro Portugal.",
    ...
    plano: {
      pt: [
        { f: "Dias 1 a 30", t: "Entrar na fábrica", i: ["Auditoria do conteúdo atual e da concorrência ibérica", "2 dias de filmagem na fábrica, banco de imagens próprio", "Mapear a gama por perfil de jogador, não por modelo"] },
        { f: "Dias 31 a 60", t: "Pôr a história a andar", i: ["Série \"Feito em Portugal\" no ar (formato repetível)", "Conteúdo de teste de raquete com jogadores reais", "Primeiros testes Meta Ads segmentados por nível de jogo"] },
        { f: "Dias 61 a 90", t: "Transformar em vendas", i: ["Plano de lançamento para a próxima edição especial", "Programa de embaixadores em clubes do Norte", "Relatório de canal + calendário do trimestre seguinte"] }
      ],
      en: [
        { f: "Days 1 to 30", t: "Get inside the factory", i: ["Audit current content and Iberian competitors", "2 filming days at the factory, build an owned image bank", "Map the range by player profile, not by model"] },
        { f: "Days 31 to 60", t: "Put the story in motion", i: ["\"Made in Portugal\" series live (repeatable format)", "Racket-testing content with real players", "First Meta Ads tests segmented by playing level"] },
        { f: "Days 61 to 90", t: "Turn it into sales", i: ["Launch plan for the next special edition", "Ambassador programme across northern clubs", "Channel report + next quarter's calendar"] }
      ],
      es: [
        { f: "Días 1 a 30", t: "Entrar en la fábrica", i: ["Auditoría del contenido actual y de la competencia ibérica", "2 días de rodaje en la fábrica, banco de imágenes propio", "Mapear la gama por perfil de jugador, no por modelo"] },
        { f: "Días 31 a 60", t: "Poner la historia a andar", i: ["Serie \"Hecho en Portugal\" en el aire (formato repetible)", "Contenido de prueba de pala con jugadores reales", "Primeros tests de Meta Ads segmentados por nivel de juego"] },
        { f: "Días 61 a 90", t: "Convertir en ventas", i: ["Plan de lanzamiento para la próxima edición especial", "Programa de embajadores en clubes del norte", "Informe de canal + calendario del trimestre siguiente"] }
      ]
    }
  },
  ...
  cork: {
    ...
    plano: {
      pt: [
        { f: "Dias 1 a 30", t: "Aprender o ofício", i: ["Dias na fábrica de Fátima e na flagship de Lisboa", "Auditoria: o que a marca diz vs. o que o jogador percebe", "Definir a linha editorial por família de raquete"] },
        { f: "Dias 31 a 60", t: "Usar a Arena", i: ["Rotina de gravação mensal na Cork Padel Arena", "Série sobre cortiça e antivibração para não-técnicos", "Ativação da parceria Sporting em conteúdo"] },
        { f: "Dias 61 a 90", t: "Abrir portas", i: ["Programa de testes em clubes (raquete na mão do jogador)", "Funil de conversão flagship + online", "Calendário trimestral e relatório de resultados"] }
      ],
      en: [
        { f: "Days 1 to 30", t: "Learn the craft", i: ["Days at the Fátima factory and the Lisbon flagship", "Audit: what the brand says vs. what the player understands", "Define the editorial line per racket family"] },
        { f: "Days 31 to 60", t: "Use the Arena", i: ["Monthly shooting routine at the Cork Padel Arena", "Series on cork and anti-vibration for non-technical players", "Turn the Sporting partnership into content"] },
        { f: "Days 61 to 90", t: "Open doors", i: ["Club testing programme (racket in the player's hand)", "Flagship + online conversion funnel", "Quarterly calendar and results report"] }
      ],
      es: [
        { f: "Días 1 a 30", t: "Aprender el oficio", i: ["Días en la fábrica de Fátima y en la flagship de Lisboa", "Auditoría: lo que dice la marca vs. lo que entiende el jugador", "Definir la línea editorial por familia de pala"] },
        { f: "Días 31 a 60", t: "Usar la Arena", i: ["Rutina de grabación mensual en la Cork Padel Arena", "Serie sobre corcho y antivibración para no técnicos", "Activación de la alianza con el Sporting en contenido"] },
        { f: "Días 61 a 90", t: "Abrir puertas", i: ["Programa de pruebas en clubes (pala en la mano del jugador)", "Embudo de conversión flagship + online", "Calendario trimestral e informe de resultados"] }
      ]
    }
  },
  ...
  vekt: {
    ...
    plano: {
      pt: [
        { f: "Dias 1 a 30", t: "Definir a marca", i: ["Posicionamento e voz, o que a VEKT é e não é", "Auditoria de concorrentes ibéricos e internacionais", "Kit base: perfis, bio, identidade de conteúdo"] },
        { f: "Dias 31 a 60", t: "Ocupar a categoria", i: ["Série educativa: grip, suor, espessura, quando trocar", "Testes com jogadores federados e amadores", "Primeiros parceiros: academias e lojas"] },
        { f: "Dias 61 a 90", t: "Repetir a compra", i: ["Campanha de subscrição/pack para jogadores frequentes", "Presença em torneios locais", "Métricas base + plano do trimestre seguinte"] }
      ],
      en: [
        { f: "Days 1 to 30", t: "Define the brand", i: ["Positioning and voice, what VEKT is and is not", "Audit of Iberian and international competitors", "Base kit: profiles, bio, content identity"] },
        { f: "Days 31 to 60", t: "Own the category", i: ["Educational series: grip, sweat, thickness, when to change", "Tests with federated and amateur players", "First partners: academies and shops"] },
        { f: "Days 61 to 90", t: "Drive repeat purchase", i: ["Subscription/pack campaign for frequent players", "Presence at local tournaments", "Baseline metrics + next-quarter plan"] }
      ],
      es: [
        { f: "Días 1 a 30", t: "Definir la marca", i: ["Posicionamiento y voz, qué es y qué no es VEKT", "Auditoría de competidores ibéricos e internacionales", "Kit base: perfiles, bio, identidad de contenido"] },
        { f: "Días 31 a 60", t: "Ocupar la categoría", i: ["Serie educativa: grip, sudor, grosor, cuándo cambiar", "Tests con jugadores federados y amateurs", "Primeros socios: academias y tiendas"] },
        { f: "Días 61 a 90", t: "Repetir la compra", i: ["Campaña de suscripción/pack para jugadores frecuentes", "Presencia en torneos locales", "Métricas base + plan del trimestre siguiente"] }
      ]
    }
  },
  ...
  volt: {
    ...
    pitch: {
      pt: {
        ...
        paras: [
          "Desde 2016 que a VOLT escolheu o caminho mais difícil: ser minimalista num setor que grita. Tipografia monoespaçada, estética limpa, o conceito de voltagem como identidade. É uma decisão de marca rara e exige conteúdo à altura, porque minimalismo mal executado lê-se como silêncio.",
      ...
      en: {
        ...
        paras: [
          "Since 2016 VOLT has taken the harder route: being minimalist in a sector that shouts. Monospaced type, clean aesthetics, voltage as identity. It is a rare brand decision and it demands content to match, because badly executed minimalism reads as silence.",
    ...
    plano: {
      pt: [
        { f: "Dias 1 a 30", t: "Entender o código", i: ["Auditoria da identidade e do conteúdo atual", "Mapear os 3 mercados prioritários fora de Portugal", "Guia editorial: como soa a VOLT em PT/EN/ES"] },
        { f: "Dias 31 a 60", t: "Produzir com jogadores", i: ["Conteúdo com atletas da marca, formato repetível", "Série técnica: formato diamante vs. lágrima, sem jargão", "Testes pagos por mercado"] },
        { f: "Dias 61 a 90", t: "Internacionalizar", i: ["Plano de lançamento multi-idioma para a próxima gama", "Rede de distribuidores como canal de conteúdo", "Relatório por mercado + calendário trimestral"] }
      ],
      en: [
        { f: "Days 1 to 30", t: "Learn the code", i: ["Audit of identity and current content", "Map the 3 priority markets outside Portugal", "Editorial guide: how VOLT sounds in PT/EN/ES"] },
        { f: "Days 31 to 60", t: "Produce with players", i: ["Content with brand athletes, repeatable format", "Technical series: diamond vs. teardrop, no jargon", "Paid tests per market"] },
        { f: "Days 61 to 90", t: "Go international", i: ["Multi-language launch plan for the next range", "Distributor network as a content channel", "Per-market report + quarterly calendar"] }
      ],
      es: [
        { f: "Días 1 a 30", t: "Entender el código", i: ["Auditoría de la identidad y del contenido actual", "Mapear los 3 mercados prioritarios fuera de Portugal", "Guía editorial: cómo suena VOLT en PT/EN/ES"] },
        { f: "Días 31 a 60", t: "Producir con jugadores", i: ["Contenido con atletas de la marca, formato repetible", "Serie técnica: formato diamante vs. lágrima, sin jerga", "Tests pagados por mercado"] },
        { f: "Días 61 a 90", t: "Internacionalizar", i: ["Plan de lanzamiento multi-idioma para la próxima gama", "Red de distribuidores como canal de contenido", "Informe por mercado + calendario trimestral"] }
      ]
    }
  }
};
